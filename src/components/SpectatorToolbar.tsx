...
export function SpectatorToolbar({ colors, selectedColor, tool, onSelectColor, onSelectTool }: Props) {
  return (
    <div className="spectatorBar" role="toolbar" aria-label="drawing tools">
